...
function Question() {
  ...
  // Sesuaikan Pencarian Trending Anda sendiri
  const trends = ['Kenapa pacarku lucu sekali?', 'Kenapa harus amel?', `Siapa yang sayang adik? Aku Aku!`, 'Sayang Amel banyak banyak', 'Amel cantik <3', 'Amel punya aku', 'Sayang adik banyak-banyak', 'Siapa yang mau di kiss? mweheheh']

  const handleSearch = (e) => {
    e.preventDefault()
    if (searchQuery.toLowerCase() === 'sudah berapa lama kita bersama?' || searchQuery.toLowerCase() === 'sudah berapa lama kita bersama?') {
          navigate("/timer");
       ...
       <div
        ...
        >
          ...
          <div className="mt-8 w-full max-w-[600px]">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-2xl">Trending saat ini</h2>
        ...
        <div className="flex flex-col min-h-screen w-full max-w-[480px] mx-auto ">
          ...
          <div className='mt-10  px-5 text-white/50'>
            <p>coba telusuri "Sudah berapa lama kita bersama?" ;)</p>
          </div>
        </div>
      )}
    </div>
