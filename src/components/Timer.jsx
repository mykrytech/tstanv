...
function Timer() {
  // Anniversary date
  const START_DATE = new Date('2024-01-20')
...
>
  <div className="text-center z-10">
    ...
    <h1 className="text-lg sm:text-2xl font-bold mb-8 drop-shadow-lg">
     Bersama adik kecilnya aku selama:
    </h1>
    ...
    <p className=' text-lg mb-8 drop-shadow-lg'>{`... dan masih menghitung <3, Tidak hts lagi xixixixiixi....` }</p>
    {/* Button */}
    <div className="flex justify-center w-full">
      ...
      >
        Maspik sayang amellll<ArrowRight/>
      </button>
    </div>
  </div>
</div>
